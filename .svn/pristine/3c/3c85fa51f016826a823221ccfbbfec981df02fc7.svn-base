...
public class DataFeeder {
	...
	public List<String> getMalyalamStopList(){
		String []stop_hi = mContext.getResources().getStringArray(R.array.stoplist_ml);
		List<String> list = Arrays.asList(stop_hi);
		return list;
	}
	...
	public ArrayList<line> getLastStopNameList(){
		return lastStopNameList;
	}
	...
	public List<String> getTamilLineList(){
		return tamilLineNameList;
	}
	

	public List<String> getTeluguLinelist() {
		return teluguLineNameList;
	}
	...
	public List<String> getMalyalamLinelist() {
		return malyalamLineNameList;
	}
